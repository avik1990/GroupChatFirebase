...
public class Dashboard_group_adapter extends RecyclerView.Adapter<Dashboard_group_adapter.VHItem> {
    Context mContext;
    int rowLayout;
    ...
    public Dashboard_group_adapter(Context mContext, int rowLayout, List<GroupMembers> ibsMembers, String flag) {
        this.mContext = mContext;
        this.rowLayout = rowLayout;
        this.flag = flag;
        this.dataMembers = ibsMembers;
       /* for (int i = 0; i < dataMembers.size(); i++) {
            if (!dataMembers.get(i).getUser_name().equals("0")) {
                dataMembers_temp.add(new GroupMembersDetails(dataMembers.get(i).getUser_id(), dataMembers.get(i).getUser_image(), dataMembers.get(i).getUser_name()));
            }
        }*/
    ...
    public void onBindViewHolder(final VHItem viewHolder, final int position) {
        try {
                ...
                viewHolder.main_view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                       ...
                       // GroupMemberSel.et_searchview.setText("");
                        LCHashMapUtils.m_group_members1.set(MemberClubAdapter.dataMembers_temp_id.indexOf(viewHolder.tv_id.getText().toString()), new GroupMembers("0", "0", "0"));
            ...
            /*if (dataMembers_temp.size() == 0) {
                Toast.makeText(mContext,"Hello123",Toast.LENGTH_SHORT).show();
                GroupMemberSel.hideview();
            }*/
