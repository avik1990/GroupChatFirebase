package com.app.classdiary.chat.chatadapter;
...
public class ChatFirebaseAdapter extends FirebaseRecyclerAdapter<ChatModel,ChatFirebaseAdapter.MyChatViewHolder> {
    ...
    public ChatFirebaseAdapter(DatabaseReference ref, String nameUser,String userMobile, ClickListenerChatFirebase mClickListenerChatFirebase) {
    ...
    public int getItemViewType(int position) {
        ...
        if (model.getMapModel() != null){
            if (model.getUserModel().getPhone().equals(userMobile)){
                return RIGHT_MSG_IMG;
            }else{
                return LEFT_MSG_IMG;
            }
        }else if (model.getFile() != null){
            if (model.getFile().getType().equals("img") && model.getUserModel().getPhone().equals(userMobile)){
                return RIGHT_MSG_IMG;
            }else{
                return LEFT_MSG_IMG;
            }
        }else if (model.getUserModel().getPhone().equals(userMobile)){
            return RIGHT_MSG;
        }else{
            return LEFT_MSG;
        }
